    ...
    for drill in last_fam:
        ...
        for combo in combos:
            ...
            # if it's in the right range - update the session options dict
                ...
                session_options[session_title]["exceeded limit probabilities"] = (round(proba_low, 3), round(proba_high, 3))
...
a = {
    ...
    {
        'fams': ["RONDO", "SSG","SSG"],
        'parameter': "Distance per Minute (alt.)",
        'min_val': 149,
        'max_val': 150,
    },
    'constrains':
    {
        ...
        {
            'fams': ['RONDO'],
            'parameter': "Distan per Minute (alt.)",
            'operator': 'range',
            'min_val': 40,
            'max_val': 62,
        }
