...
def update_data(new_data_file, families_file="../data/families.json", json_file="../data/stats.json"):
    try:
            ...
            for row in csvreader:
                ...
                for parameter in parameters_list:
                    ...
                    if drill_name not in stats_dict:
                        stats_dict[drill_name] = {'num of sets': 0, 'sets list': [], 'parameters': {}}
                    if parameter not in stats_dict[drill_name]['parameters']:
                        stats_dict[drill_name]['parameters'][parameter] = {"team's mean": 0,
                                                                           "team's variance": 0, 'players': {}}
                    ...
                    if (session_num, raw_drill_name) not in temp_sets:
                        ...
                        stats_dict[drill_name]['num of sets'] = stats_dict[drill_name]['num of sets'] + 1
        ...
        for drill_name in stats_dict:
            ...
            for parameter in stats_dict[drill_name]['parameters']:
                ...
                val_counter = 0
                for player_name in stats_dict[drill_name]['parameters'][parameter]['players']:
                    player_value = stats_dict[drill_name]['parameters'][parameter]['players'].get(player_name, [0, 0])
                    player_value.pop(0)
                    player_value.pop(0)
                ...
                if families[fam_name][drill_name]['parameters'].get(parameter, {}) == {}:
                    families[fam_name][drill_name]['parameters'][parameter] = {"team's mean": 0, "team's variance": 0}
        ...
        for fam in families:
            families[fam] = dict(sorted(families[fam].items(),
